...
import { Copy, Eye, EyeOff, Printer, RefreshCw, AlertTriangle, Shield, Wallet, KeyRound } from 'lucide-react';
  ...
  return (
    <div className="max-w-5xl mx-auto px-4 py-8 animate-fade-in pb-24">
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-8 gap-4 print:hidden">
        <div>
           ...
           {wallet.hasPassphrase && (
             <div className="mt-3 inline-flex items-center gap-2 rounded border border-blue-500/30 bg-blue-500/10 px-3 py-1 text-xs font-semibold text-blue-300">
               <KeyRound size={14} /> Passphrase Protected
             </div>
           )}
        </div>
      ...
      <div className="hidden print:block mt-8 text-center text-sm text-gray-500">
        ...
        {wallet.hasPassphrase && <p>BIP-39 PASSPHRASE REQUIRED TO RESTORE THIS WALLET.</p>}
